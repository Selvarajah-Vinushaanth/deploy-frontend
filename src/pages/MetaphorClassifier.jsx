...
<div className="bg-gray-800/80 backdrop-blur-sm border border-gray-700 rounded-xl shadow-xl p-6 transition-all duration-300 hover:shadow-purple-900/20">
  ...
  <div className="max-w-4xl mx-auto px-6">
    ...
    <div className="flex flex-col md:flex-row justify-center items-center space-y-2 md:space-y-0 md:space-x-4">
      <div className="flex items-center">
        <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-pink-400 mr-2" viewBox="0 0 20 20" fill="currentColor">
    ...
    <p className="mt-3 text-gray-400 text-xs">Powered by natural language processing</p>
