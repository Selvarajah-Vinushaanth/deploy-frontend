...
export default function LyricGenerator() {
  ...
  const motions = [
    { value: 'calm', label: 'Calm / அமைதி', color: 'bg-blue-600', icon: '🌊' },
    { value: 'happy', label: 'Happy / சந்தோஷம்', color: 'bg-yellow-500', icon: '😊' },
    { value: 'sad', label: 'Sad / கவலை', color: 'bg-purple-600', icon: '😢' },
    { value: 'romantic', label: 'Romantic / காதல்', color: 'bg-pink-500', icon: '💖' },
    { value: 'energetic', label: 'Energetic / உற்சாகம்', color: 'bg-red-500', icon: '⚡' }
  ];
...
const handleExampleClick = (example) => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-900 to-black text-gray-100 relative">
      ...
      <aside className="hidden md:flex flex-col fixed right-0 top-[88px] h-[calc(100vh-88px)] w-80 bg-gray-900/90 border-l border-gray-800 rounded-l-2xl shadow-2xl z-40 p-6 overflow-y-auto space-y-6"
      ...
      {/* Main Content */}
      <div className="max-w-10xl mx-auto p-6 space-y-8 md:pr-96">
        {error && (
      ...
      <footer className="mt-12 py-8 text-center text-gray-400 text-sm border-t border-gray-800/70 bg-black/30 backdrop-blur-sm">
        <div className="max-w-4xl mx-auto px-6">
          ...
          <div className="flex flex-col md:flex-row justify-center items-center space-y-2 md:space-y-0 md:space-x-4">
            ...
            <div>Created by Vinushaanth</div>
          </div>
